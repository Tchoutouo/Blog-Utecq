...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            <nav class="navbar navbar-expand-lg bg-primary fixed-top" style="height: 10%;">
                <div class="container-fluid">
                    <a class="navbar-brand fs-2 fw-bolder text-white" href="#"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Blog-Utecq</font></font></a>
                    ...
                    @if (Route::has('login'))
                        ...
                        <div class="collapse navbar-collapse" id="navbarScroll">
                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll m-3"     style="--bs-scroll-height: 100px; position:relative; left: 85%;">
                            @auth
                                <li class="nav-item border rounded-3">
                                    <a class="nav-link active fw-bold text-white" aria-current="page" href="{{ url('/dashboard') }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Dashboard</font></font></a>
                                </li>
                            @else
                            
                                <li class="nav-item border rounded-3">
                                    <a class="nav-link fw-bold text-white " href="{{ route('login') }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Se connecter</font></font></a>
                                </li>

                                @if (Route::has('register'))
                                    <li class="nav-item border rounded-3">
                                        <a class="nav-link fw-bold text-white" href="{{ route('register') }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">S'inscrire</font></font></a>
                                    </li>
                                @endif
                            @endauth
            ...
            <div class="container">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="margin-top: 150px;">
                    <form action="{{route('welcome')}}" class="form-inline ml-auto mt-3" >
                        <div class="input-group rounded m-auto w-50 mt-5 mb-5">
                            <input  id="search" value="{{request()->search}}" name="search" class="form-control text-center rounded " placeholder="Rechercher un article"/>
                        ...
                        @forelse ($articles as $article)
                            <div class="card border-secondary mb-3">
                                <div class="card-header bg-transparent border-secondary fw-bold fs-2"              style="background-color: rgb(199, 199, 247) !important;">
                                    Auteur: <span style="background-color: green !important "> 
                                    {{$article->auteur}}
                                    </span>
